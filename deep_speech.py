...
def generate_dataset(flags_obj, data_dir):
...
def run_deep_speech(flags_obj):
  """Run deep speech training and eval loop."""
  tf.compat.v1.set_random_seed(flags_obj.seed)
  # Data preprocessing
  logging.info("Data preprocessing...")
  train_speech_dataset = generate_dataset(flags_obj, flags_obj.train_data_dir)
  eval_speech_dataset = generate_dataset(flags_obj, flags_obj.eval_data_dir)
...
def define_deep_speech_flags():
  ...
  absl_flags.adopt_module_key_flags(flags_core)
